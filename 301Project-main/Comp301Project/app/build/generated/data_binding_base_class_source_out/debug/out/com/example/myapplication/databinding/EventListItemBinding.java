...
public final class EventListItemBinding implements ViewBinding {
  ...
  private EventListItemBinding(@NonNull LinearLayout rootView, @NonNull TextView eventDescription,
  ...
  public static EventListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new EventListItemBinding((LinearLayout) rootView, eventDescription, eventName);
    }
