...
public final class FragmentFirstBinding implements ViewBinding {
  ...
  @NonNull
  public final Button UserProfile;
  ...
  private FragmentFirstBinding(@NonNull NestedScrollView rootView, @NonNull Button UserProfile,
      @NonNull Button buttonFirst, @NonNull TextView textviewFirst) {
  ...
  public static FragmentFirstBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.UserProfile;
      Button UserProfile = ViewBindings.findChildViewById(rootView, id);
      if (UserProfile == null) {
        break missingId;
      }
      ...
      return new FragmentFirstBinding((NestedScrollView) rootView, UserProfile, buttonFirst,
          textviewFirst);
    }
